...
public class BottleProblemTest {
    ...
    @Test
    void verse16(){
        String expected = "16 bottles of beer on the wall, 16 bottles of beer.\n" +
                "Take one down and pass it around, 15 bottles of beer on the wall.\n";
        BottleProblem bottleProblem = new BottleProblem();
        assertEquals(expected, bottleProblem.verse(16));
    }


    @Test
    void verse127(){
        String expected = "Invalid Verse";
        BottleProblem bottleProblem = new BottleProblem();
        assertEquals(expected, bottleProblem.verse(127));
    }

    @Test
    void verseRange1(){
        String expected = "60 bottles of beer on the wall, 60 bottles of beer.\n" +
        ...
        BottleProblem bottleProblem = new BottleProblem();
        assertEquals(expected, bottleProblem.verses(60, 49));
    }


    @Test
    void verseRange2(){
        String expected = "27 bottles of beer on the wall, 27 bottles of beer.\n" +
                ...
                "Go to the store and buy some more, 99 bottles of beer on the wall.\n";
        BottleProblem bottleProblem = new BottleProblem();
        assertEquals(expected, bottleProblem.verses(27, 0));
    }
    ...
    void fullSong(){
        String expected = "99 bottles of beer on the wall, 99 bottles of beer.\n" +
                ...
                BottleProblem bottleProblem = new BottleProblem();
                assertEquals(expected, bottleProblem.fullSong());
    }
